	...
	"inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary/40 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
	{
		variants: {
			variant: {
				...
				"premium-gradient":
					"btn-gradient text-on-primary font-bold tracking-wider uppercase text-xs",
				"premium-social":
					"bg-surface-container-low border border-outline-variant/10 hover:bg-surface-container-high text-on-surface-variant hover:text-white",
			},
			size: {
				default: "h-11 px-6",
				sm: "h-9 px-3 text-xs",
